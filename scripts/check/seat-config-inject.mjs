...
// The exact command string the main repo's `.claude/settings.local.json`
// already uses to wire role-guard.mjs (verified by CODER reading that file
// directly, 2026-09-10) -- reused verbatim so a worktree generated by this
// module and the main repo's own hand-authored file are wire-compatible.
